...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('writeevents_core_path', null,
                    $modx->getOption('core_path') . 'components/writeevents/') . 'model/';
            $modx->addPackage('writeevents', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/writeevents/model/schema/writeevents.mysql.schema.xml';
